...
Piąty rozdział dotyczy kwestii implementacji programu. Składa się on z pięciu podrozdziałów. Pierwszy z nich przedstawia ogólny schemat działania algorytmu, aby pokrótce zaznajomić odbiorcę z jego strukturą. Kolejne części zawierają szczegóły każdego z etapów animacji awatara.

Szósty rozdział został poświęcony części ewaluacyjnej. Zawarto w nim opis aplikacji wykorzystanej jako technologia umożliwiająca efektywne przeprowadzenie walidacji.  Przedstawiono w nim także efekty testów algorytmu pod kątem użyteczności programu oraz osiąganych rezultatów.
